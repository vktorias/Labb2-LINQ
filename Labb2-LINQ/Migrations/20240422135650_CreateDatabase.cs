    ...
    public partial class CreateDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, 1, "Ellen", "Berg", null },
                    { 2, 2, "Erik", "Karlsson", null },
                    { 3, 3, "Karolin", "Jonsson", null },
                    { 4, 4, "Jonas", "Ytterbom", null },
                    { 5, 4, "Patricia", "Larsson", null },
                    { 6, 2, "Rickard", "Svensson", null },
                    { 7, 2, "Klara", "Hedman", null },
                    { 8, 3, "Hampus", "Lagergren", null },
                    { 9, 2, "Lisa", "Löf", null },
                    { 10, 1, "Kalle", "Broman", null },
                    { 11, 2, "Erik", "Bergman", null },
                    { 12, 2, "Johan", "Larsson", null },
                    { 13, 4, "Johanna", "Eriksson", null },
                    { 14, 3, "Gunilla", "Olsson", null }
                });
